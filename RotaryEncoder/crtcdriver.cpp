...
CRtcdriver::CRtcdriver(const unsigned int &SWITCH, const unsigned int &CLK, const unsigned int &DT)
    : _rotaryCounter(0)
{
    this->_pin1 = SWITCH;
    this->_pin2 = CLK;
...
void CRtcdriver::setPins(const unsigned int &SWITCH, const unsigned int &CLK, const unsigned int &DT)
{
    this->_pin1 = SWITCH;
    this->_pin2 = CLK;
    this->_pin3 = DT;
