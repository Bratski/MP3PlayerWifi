% mp3playerwifi(SECTION) | User Commands
%
% "April  7 2025"
...
mp3playerwifi - program to do something

# SYNOPSIS

**mp3playerwifi** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**mp3playerwifi** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **mp3playerwifi** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**mp3playerwifi** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    mp3playerwifi. See **foo.conf**(5) for further details.
...
**mp3playerwifi** provides some return codes, that can be used in scripts:
...
Bart Zonderland <bart@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Bart Zonderland
